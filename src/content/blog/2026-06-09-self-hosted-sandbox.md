...
L'environnement d'exécution est protégé mais le risque de fuite de données demeure. J'ai résumé l'architecture dans le schéma ci-dessous, sur lequel je travaille pour préparer un cours : dans ce schéma c'est la flèche « tool_result » horizontale qui correspond au problème.

![Architecture self-hosted sandbox](/self-hosted_sandbox.png)
